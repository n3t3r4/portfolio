  ...
  return (
    <>
      <div className="z-0 flex flex-col items-start justify-center pt-2 text-white">
        <div className="flex flex-col items-center m-3 cursor-pointer min-w-[80px] max-w-[80px] selectable">
          <div>
            <img src={ProjetosIcon} className="max-w-[90px] my-[-20px]" />
          </div>
          <div>Projetos</div>
        </div>
        <div className="flex flex-col items-center m-3 cursor-pointer min-w-[80px] selectable">
          <div>
